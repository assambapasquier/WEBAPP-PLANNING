...
<body class="nav-md">
                                    ...
                                    if($v != null){
                                        ...
                                        echo '<li class="list-group-item">
                                            ...
                                            <div class="col-xs-2 col-md-2">
                                                <img src="'.base_url().'asset/images/calendrier.jpg" class="img-circle img-responsive" alt="" />
                                            </div>

                                            <div class="col-xs-10 col-md-10">
                                                <div>
                                                    <a style="color:rgb(0,132,232);" onclick="jsperm("1")>'
                                                        .$v['libelle'].
                                                   '</a>
                                                    <div class="mic-info">'.
                                                        $v['description'].
                                                ...
                                                <a href="'.base_url().'utilisateur/permanence/'.$v['id'].'"><button class="btn btn-primary" title="permanence">
                                                    <span class="fa fa-calendar"></span> Permanences
                                                </button></a>

                                                <a href="'.base_url().'utilisateur/astreinte/'.$v['id'].'"><button class="btn btn-warning" title="astreintes">
                                                    <span class="fa fa-calendar-o"></span> Astreintes
                                                </button></a>
                                            </div>
                                            </div>
                                        </li>';
    ...
    <script src="<?php echo base_url(); ?>asset/js/bootstrap.min.js"></script>
        ...
        <!--------------------------------------------apres avoir cliqué sur un lien je prend l'id du lie--------->
        <script>
            $('button').click(function() {
                $('.plann').val($(this).attr('id'))
            });
            /*$('.plann').click(function(){
                var clickedID = $(this).attr('id');
                window.location = <?php echo base_url(); ?>'responsable/permanences/' + clickedID;
            });​*/
        </script>
    </body>
</html>