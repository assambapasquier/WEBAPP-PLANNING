                    ...
                    <div class="row" style="margin-top: 125px;">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                              <div class="x_panel">
                                <div class="x_title">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <h3>Planning hebdo des astreintes: "<?php echo $nom_dept; ?>"</h3> 
                                    </div>
                                ...
                                <div class="x_content">
                                    <div class="row">
                                        <form method="POST" action="<?php echo base_url()?>utilisateur/traitement_filtre_astr<?php echo '/'.$this->input->get('id');?>">
                                    ...
                                    <?php include('tableaux/tableau_astreintes.php'); ?>
                                </div>
                              </div>
                            </div>
